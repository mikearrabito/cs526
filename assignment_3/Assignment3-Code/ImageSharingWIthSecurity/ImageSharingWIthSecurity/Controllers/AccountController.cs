...
namespace ImageSharingWithSecurity.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Login(LoginModel model, string returnUrl)
        {
            ...
            return View(model); // user not found in active users
        }
        ...
        public async Task<IActionResult> Manage()
        {
            ...
            if (!isAdmin)
            {
                ...
                ViewBag.Message = "You are not allowed to manage users";
                return View(new ManageModel { Users = new List<SelectListItem>() });
            }
            else
            {
